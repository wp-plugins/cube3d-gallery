...
/*
	...
	Author URI: http://www.pluginswp.com/cylinder3d-gallery/
...
$texto.='&cantidad='.$conta.'&row=8&colorbordes='.'cccccc'.'&colortextos='.'cccccc'.'&vertical=1&zoom1='.$zoom1.'&zoom2=150&target='.$target.'&onlink='.$imageslink.'&speed=4&mouseover='.$onover.'&alpha='.$alpha.'&menu1='.$menu1.'&menu2='.$menu2.'&menu3='.$menu3.'&menu4='.$menu4.'&menu5='.$menu5.'&menu6='.$menu6.'&menu7='.$menu7;
